...
--
-- Host: localhost    Database: gaming_vault
-- ------------------------------------------------------
...
INSERT INTO `generi` VALUES (1,'Action'),(2,'RPG'),(3,'FPS'),(4,'Platform'),(5,'Horror');
...
CREATE TABLE `giochi` (
  ...
  `stato` enum('Da iniziare','In corso','Completato') DEFAULT 'Da iniziare',
  `data_aggiunta` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `id_genere` (`id_genere`),
  CONSTRAINT `giochi_ibfk_1` FOREIGN KEY (`id_genere`) REFERENCES `generi` (`id`) ON DELETE SET NULL
...
-- Dump completed on 2026-05-14 16:46:18
